    ...
    <div class="container">
        ...
        <div class="store">
            <div class="product">
                ...
                <p>Model Bentuk Rantai</p>
                <p>Bahan Kayu</p>
                <p>Berat 0.5gr</p>
                <p>Harga: Rp 50.000</p>
                <form method="post" action="">
                    <input type="hidden" name="item_name" value="Gelang Murah Meriah">
            ...
            <div class="product">
                ...
                <p>Model Bentuk liontin</p>
                <p>Bahan Emas asli dengan kadar 700</p>
                <p>Berat 0.65gr</p>
                <p>Harga: Rp 100.000</p>
                <form method="post" action="">
                    <input type="hidden" name="item_name" value="Gelang Tali Liontin">
            ...
            <div class="product">
                ...
                <p>Model Aksesoris Rantai</p>
                <p>Bahan Emas asli 24K</p>
                <p>Berat 1gr</p>
                <p>Harga: Rp 250.000</p>
                <form method="post" action="">
                    <input type="hidden" name="item_name" value="Gelang Bola Lapis Emas">
